...
def demo_estate() -> MockBPClient:
    ...
    resources = [
        ...
        _worker(
            _D_BOT_H02, "BOT-H02", "HR Pool", "HR", "Offline", database_status="Offline"
        ),
        ...
        _worker(
            _D_BOT_O03, "BOT-O03", "Onboarding Pool", "Onboarding", "Offline",
            database_status="Offline",
        ),
    ]

    resource_pools = [
        {"id": "3a5e7c9d-1b46-4f82-8e10-0000000d0501", "name": "Finance Pool",
         "members": 3, "databaseStatus": "Ready"},
        {"id": "3a5e7c9d-1b46-4f82-8e10-0000000d0502", "name": "HR Pool",
         "members": 2, "databaseStatus": "Ready"},
        {"id": "3a5e7c9d-1b46-4f82-8e10-0000000d0503", "name": "Onboarding Pool",
         "members": 3, "databaseStatus": "Ready"},
    ]
    ...
    queues = [
        ...
        _queue(_QUEUE_ONBOARDING, "Onboarding", "Operations", "Paused",
               pending=35, completed=214, locked=0, exceptioned=4,
               average="00:03:02", key_field="Customer Id"),
        # The healthy bulk — no exceptions — so a console's collapsed-healthy
        # summary has a real count to fold away.
        _queue(_D_QUEUE_PAYROLL, "Payroll", "HR", "Running",
               pending=4, completed=320, locked=0, exceptioned=0, average="00:04:20"),
        _queue(_D_QUEUE_EXPENSES, "Expenses", "Finance", "Running",
               pending=9, completed=410, locked=1, exceptioned=0, average="00:01:05"),
        _queue(_D_QUEUE_VENDOR, "Vendor Setup", "Operations", "Running",
               pending=2, completed=95, locked=0, exceptioned=0, average="00:05:40"),
        _queue(_D_QUEUE_COMPLIANCE, "Compliance Checks", "Operations", "Running",
               pending=0, completed=150, locked=0, exceptioned=0, average="00:02:30"),
        _queue(_D_QUEUE_MAILROOM, "Mailroom", "Operations", "Running",
               pending=7, completed=260, locked=0, exceptioned=0, average="00:00:45"),
        _queue(_D_QUEUE_CLOSURES, "Account Closures", "Operations", "Running",
               pending=1, completed=73, locked=0, exceptioned=0, average="00:06:10"),
    ]

    processes = [
        {"processId": _PROC_INVOICES, "processName": "Invoice Processing",
         "processDescription": "Three-way match and ledger posting",
         "groupName": "Finance", "attributes": ["Published"]},
        {"processId": _PROC_ONBOARDING, "processName": "Customer Onboarding",
         "processDescription": "KYC checks and account creation",
         "groupName": "Operations", "attributes": ["Published"]},
        {"processId": _D_PROC_PAYMENTS, "processName": "Payment Run",
         "processDescription": "Outbound BACS payment file generation",
         "groupName": "Finance", "attributes": ["Published"]},
        {"processId": _D_PROC_PAYROLL, "processName": "Payroll Run",
         "processDescription": "Monthly payroll calculation and posting",
         "groupName": "HR", "attributes": ["Published"]},
        {"processId": _D_PROC_COMPLIANCE, "processName": "Compliance Screening",
    ...
    sessions = [
        ...
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0301", 1, _PROC_INVOICES,
                 "Invoice Processing", _D_BOT_F01, "BOT-F01", "Completed",
                 _recent(360), _recent(352)),
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0302", 2, _PROC_INVOICES,
                 "Invoice Processing", _D_BOT_F01, "BOT-F01", "Completed",
                 _recent(300), _recent(292)),
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0303", 3, _PROC_ONBOARDING,
                 "Customer Onboarding", _D_BOT_O01, "BOT-O01", "Completed",
                 _ts(1, "11:00:00"), _ts(1, "11:09:00")),
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0304", 4, _D_PROC_PAYROLL,
                 "Payroll Run", _D_BOT_H01, "BOT-H01", "Completed",
                 _ts(2, "07:00:00"), _ts(2, "07:22:00")),
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0305", 5, _D_PROC_COMPLIANCE,
                 "Compliance Screening", _D_BOT_O01, "BOT-O01", "Completed",
                 _ts(3, "13:00:00"), _ts(3, "13:04:00")),
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0306", 6, _PROC_INVOICES,
                 "Invoice Processing", _D_BOT_F01, "BOT-F01", "Completed",
                 _ts(4, "09:00:00"), _ts(4, "09:11:00")),
        # In-flight runs on the working bots (started a couple of hours ago).
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0307", 7, _PROC_INVOICES,
                 "Invoice Processing", _D_BOT_F03, "BOT-F03", "Running",
                 _recent(150), None),
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0308", 8, _PROC_ONBOARDING,
                 "Customer Onboarding", _D_BOT_O01, "BOT-O01", "Running",
                 _recent(90), None),
        # The degrading Payment Run: two recent terminations.
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0309", 9, _D_PROC_PAYMENTS,
                 "Payment Run", _D_BOT_F02, "BOT-F02", "Terminated",
                 _recent(200), _recent(198), termination="ProcessError",
                 exception_type="System Exception",
                 exception_message="BACS gateway timed out after 30s"),
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0310", 10, _D_PROC_PAYMENTS,
                 "Payment Run", _D_BOT_F01, "BOT-F01", "Terminated",
                 _ts(1, "14:00:00"), _ts(1, "14:01:05"), termination="ProcessError",
                 exception_type="System Exception",
                 exception_message="BACS gateway timed out after 30s"),
        _session("e8a9d7c2-5f10-4b3e-bd64-0000000d0311", 11, _PROC_ONBOARDING,
                 "Customer Onboarding", _D_BOT_O01, "BOT-O01", "Terminated",
                 _ts(2, "10:00:00"), _ts(2, "10:00:50"), termination="ProcessError",
    ...
    schedules = [
        {"id": 1, "name": "Daily Invoice Run",
         "description": "Runs Invoice Processing every weekday morning",
         "isRetired": False, "tasksCount": 1, "intervalType": "Day",
         "calendarName": "Working Week"},
        {"id": 2, "name": "Nightly Payment Run",
         "description": "Generates the outbound BACS file overnight",
         "isRetired": False, "tasksCount": 1, "intervalType": "Day",
         "calendarName": "Working Week"},
        {"id": 3, "name": "Weekly Reconciliation",
         "description": "Legacy reconciliation run",
         "isRetired": True, "tasksCount": 2, "intervalType": "Week",
         "calendarName": "Working Week"},
        {"id": 4, "name": "Hourly Compliance Sync",
         "description": "Keeps the sanctions list current",
         "isRetired": False, "tasksCount": 1, "intervalType": "Hour",
         "calendarName": "All Days"},
    ]

    schedule_logs = {
        "1": [
            {"scheduleLogId": 31, "scheduleId": 1, "scheduleName": "Daily Invoice Run",
             "startTime": _ts(0, "06:00:00"), "endTime": _ts(0, "06:12:40"),
             "duration": "00:12:40", "status": "completed", "serverName": "BP-APP-01"},
        ],
        # The failed schedule: its most recent run terminated.
        "2": [
            {"scheduleLogId": 32, "scheduleId": 2, "scheduleName": "Nightly Payment Run",
             "startTime": _ts(0, "02:00:00"), "endTime": _ts(0, "02:00:45"),
             "duration": "00:00:45", "status": "terminated", "serverName": "BP-APP-02"},
        ],
        "4": [
            {"scheduleLogId": 33, "scheduleId": 4, "scheduleName": "Hourly Compliance Sync",
             "startTime": _ts(0, "08:00:00"), "endTime": _ts(0, "08:01:10"),
             "duration": "00:01:10", "status": "completed", "serverName": "BP-APP-01"},
        ],
    }
    ...
    queue_items = [
        {"queue": _QUEUE_INVOICES, "id": "f3b2a190-8c47-4e2d-9b55-0000000d0401",
         "priority": 1, "state": "Completed", "keyValue": "INV-2001", "status": "",
         "attemptNumber": 1, "lastUpdated": _recent(340), "completedDate": _recent(340),
         "workTimeInSeconds": 92, "exceptionReason": None, "resource": "BOT-F01"},
        {"queue": _QUEUE_INVOICES, "id": "f3b2a190-8c47-4e2d-9b55-0000000d0402",
         "priority": 1, "state": "Exceptioned", "keyValue": "INV-2002", "status": "",
         "attemptNumber": 2, "lastUpdated": _recent(180), "exceptionedDate": _recent(180),
         "workTimeInSeconds": 45,
         "exceptionReason": "Invoice total did not match purchase order", "resource": "BOT-F01"},
        {"queue": _QUEUE_INVOICES, "id": "f3b2a190-8c47-4e2d-9b55-0000000d0403",
         "priority": 1, "state": "Exceptioned", "keyValue": "INV-2003", "status": "",
         "attemptNumber": 1, "lastUpdated": _recent(120), "exceptionedDate": _recent(120),
         "workTimeInSeconds": 38, "exceptionReason": "Supplier not found in ledger",
         "resource": "BOT-F03"},
        {"queue": _QUEUE_INVOICES, "id": "f3b2a190-8c47-4e2d-9b55-0000000d0404",
         "priority": 2, "state": "Pending", "keyValue": "INV-2004", "status": "",
         "attemptNumber": 1, "lastUpdated": _recent(60), "workTimeInSeconds": 0,
         "exceptionReason": None, "resource": None},
        {"queue": _D_QUEUE_PAYMENTS, "id": "f3b2a190-8c47-4e2d-9b55-0000000d0405",
         "priority": 1, "state": "Exceptioned", "keyValue": "PAY-5001", "status": "",
         "attemptNumber": 1, "lastUpdated": _recent(210), "exceptionedDate": _recent(210),
         "workTimeInSeconds": 30, "exceptionReason": "BACS gateway timed out",
         "resource": "BOT-F02"},
        {"queue": _D_QUEUE_PAYMENTS, "id": "f3b2a190-8c47-4e2d-9b55-0000000d0406",
         "priority": 1, "state": "Pending", "keyValue": "PAY-5002", "status": "",
         "attemptNumber": 1, "lastUpdated": _recent(45), "workTimeInSeconds": 0,
         "exceptionReason": None, "resource": None},
    ]
    ...
    session_logs = {
        "e8a9d7c2-5f10-4b3e-bd64-0000000d0301": [
            {"logNumber": 1, "stageName": "Start", "stageType": "Start",
             "result": "", "resourceStartTime": _recent(360)},
            {"logNumber": 2, "stageName": "Read Invoice", "stageType": "Action",
             "result": "OK", "resourceStartTime": _recent(357)},
            {"logNumber": 3, "stageName": "Post to Ledger", "stageType": "Action",
             "result": "OK", "resourceStartTime": _recent(353)},
        ],
        "e8a9d7c2-5f10-4b3e-bd64-0000000d0309": [
            {"logNumber": 1, "stageName": "Start", "stageType": "Start",
             "result": "", "resourceStartTime": _recent(200)},
            {"logNumber": 2, "stageName": "Build BACS File", "stageType": "Action",
             "result": "Connecting to gateway", "resultType": "Text",
             "resourceStartTime": _recent(199)},
            {"logNumber": 3, "stageName": "Gateway Timeout", "stageType": "Exception",
             "result": "BACS gateway timed out after 30s", "resultType": "Text",
